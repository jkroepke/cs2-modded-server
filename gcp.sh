...
# Install
# As root (sudo su)
# cd / && curl --silent --output "gcp.sh" "https://raw.githubusercontent.com/jkroepke/cs2-modded-server/master/gcp.sh" && chmod +x gcp.sh && bash gcp.sh
...
curl -s -H "Cache-Control: no-cache" -o "install.sh" "https://raw.githubusercontent.com/jkroepke/cs2-modded-server/${MOD_BRANCH}/install.sh" && chmod +x install.sh
